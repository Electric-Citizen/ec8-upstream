...
oc_base provides a bare minimum of sensible defaults for all themes. For each site, a subtheme (oc_subtheme) should be used for any theming specific to the site you are working on (not global to every site).
